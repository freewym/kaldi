...
# System                cnn_tdnn_lstm_1e_dropout_batch_sp cnn_tdnn_lstm_1e_dropout_batch_backstitch_4epoch_sp
# WER on train_dev(tg)      12.52     12.48
# WER on train_dev(fg)      11.67     11.55
# WER on eval2000(tg)        14.6      14.6
# WER on eval2000(fg)        13.4      13.3
# Final train prob         -0.070    -0.087
# Final valid prob         -0.102    -0.109
# Final train prob (xent)        -0.932    -1.181
# Final valid prob (xent)       -1.0969   -1.2852
...
get_egs_stage=-10
speed_perturb=true
dir=exp/chain/cnn_tdnn_lstm_1e_dropout_batch_backstitch_4epoch # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_nj=50
...
remove_egs=false
common_egs_dir=/nobackup/s1/asr/chenggaofeng/s5c_fastlstm/exp/chain/cnn_tdnn_lstm_1e_sp/egs
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-layer name=tdnn1 input=Append(0,ReplaceIndex(ivector, t, 0)) dim=1024 
