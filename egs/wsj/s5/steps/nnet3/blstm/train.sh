...
chunk_right_context=40  # number of steps used in the estimation of LSTM state before prediction of the first label
...
if [ $stage -le -5 ]; then
  ...
  steps/nnet3/blstm/make_configs.py  "${config_extra_opts[@]}" \
