...
if [ $stage -le 1 ]; then
  ...
  res-block name=res8 num-filters=$nf3 num-bottleneck-filters=$nb3 num-blocks=$nblk3 height=8 time-period=4 $res_opts
  res-block name=res9 num-filters=$nf3 num-bottleneck-filters=$nb3 num-blocks=$nblk3 height=8 time-period=4 $res_opts
  res-block name=res10 num-filters=$nf3 num-bottleneck-filters=$nb3 num-blocks=$nblk3 height=8 time-period=4 $res_opts
