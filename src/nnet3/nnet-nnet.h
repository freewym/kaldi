...
///      case.
///    - Objectivetype kObjectiveNone is used when we need to output some hidden state that
//.      will not be invloved in computing the objective.
enum ObjectiveType { kLinear, kQuadratic, kObjectiveNone };
